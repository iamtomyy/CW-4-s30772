...
; 
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        List<Emp> result = emps.Where(e => depts.Where(d => d.Loc == "CHICAGO").Select(d => e.DeptNo).Contains(e.DeptNo)).ToList(); 
    ...
    public void ShouldSelectNamesAndSalaries()
    {
        ...
        var result = emps.Select(e => new {e.EName, e.Sal}).OrderBy(e => e).ToList(); 
    ...
    public void ShouldJoinEmployeesWithDepartments()
    {
        ...
        var result = emps.Join(depts, e => e.EmpNo, d => d.DeptNo, (e,d) => new {e.EName, d.DName}).ToList(); 
    ...
    public void ShouldCountEmployeesPerDepartment()
    {
        ...
        //var result = emps.GroupBy(e => e.DeptNo).Count(); 
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        //var result = emps.SelectMany(e => grades.Where(s => s.Grade));
        var result = (from e in emps from s in grades where e.Sal >= s.Losal && e.Sal <= s.Hisal select (e.EName, s.Grade)).ToList();
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        var result = emps.GroupBy(e => e.DeptNo).Select(g => (DeptNo: g.Key, AvgSal: g.Average(e => e.Sal))).ToList();
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var firstPart = emps.GroupBy(e => e.DeptNo).ToDictionary(g => g.Key, g => g.Average(e => e.Sal));
        
        var result = emps.Where(e => e.Sal > firstPart[e.DeptNo]).Select(e => e.EName).ToList(); 
